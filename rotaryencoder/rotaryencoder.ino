...
#define encoder_clk 3 //Arduino UNO (nano) pin 10
#define encoder_dt 2 //Arduino UNO (nano) pin 11
#define relay1 12 //Arduino UNO (nano) pin A0
#define temperatureSetupMode 4 //Rotary encoder SWITCH (SW) - button (menu entry)
